...
@section('title', 'TMS | Penjualan per Type')
        ...
        <div class="col-12 mt-6">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <h4 class="card-header-title">Penjualan per Type</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <label for="startWithType">Start with Type :</label>
                                </div>
                                <div class="col-md-2">
                                    <select class="form-select" id="startWithType" aria-label="Default select example">
                                        <option value="*" selected>* - None</option>
                                        <option value="DJ">DJ - Dies & JIG</option>
                                        <option value="MD">MD - Mould</option>
                                        <option value="MN">MN - Non Mirror</option>
                                        <option value="MR">MR - Mirror</option>
                                        <option value="PL">PL - Plastic</option>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <label for="endWithType">End with Type :</label>
                                </div>
                                <div class="col-md-2">
                                    <select class="form-select" id="endWithType" aria-label="Default select example">
                                        <option value="*">* - None</option>
                                        <option value="DJ">DJ - Dies & JIG</option>
                                        <option value="MD" selected>MD - Mould</option>
                                        <option value="MN">MN - Non Mirror</option>
                                        <option value="MR">MR - Mirror</option>
                                        <option value="PL">PL - Plastic</option>
                                        <option value="U">U -</option>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 d-flex flex-row">
                                    <div class="form-check me-2">
                                        <input class="form-check-input" type="radio" name="sortBy" id="dataType" value="type">
...
<script src="{{asset('/js/scriptPenjualan.js')}}"></script>
@endsection
