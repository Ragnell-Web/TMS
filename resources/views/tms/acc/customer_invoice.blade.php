...
<div class="page-title-area">
    <div class="row">
        <div class="col-1">
            <div class="#">
                <a href="#" class="btn btn-primary btn-round" id="add_form" data-bs-toggle="modal"
        ...
        <div class="col-1" id="tes">
            <div class="#">
                <a href="#" class="btn btn-primary btn-round" id="edit_form" data-bs-toggle="modal"
                    ...
                    <div class="col-12" style="height: 45vh;overflow: auto;">
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr class="invoice" data-id="{{$data['id']}}" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal2" data-bs-dismiss="modal">
                                    <td width="10%">{{$i++}}</td>
                                    <td width="15%" class="tdCustcode">{{$data['custcode']}}</td>
                                    <td width="45%">{{$data['company']}}</td>
                                    <td width="30%">{{$data['contact']}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
        ...
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-row">
                            ...
                            <div class="col-1 mb-2">
                                <input type="text" name="noinvoice" class="form-control form-control-sm" id="noinvoice"
                                    aria-describedby="" value="<?=$stock->getStinNo() ?>" placeholder="No Invoice"
                                    disabled>
                            </div>
                            <div class="col-1 mb-2">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-2 mb-1">
                                <input type="text" name="period" autocomplete="off" class="form-control form-control-sm"
                                    value="<?=$period; ?>" id="period" placeholder="YYYY/MM">
                            </div>
                            <div class="col-2 mb-1">
                                <input type="text" name="written" autocomplete="off"
                                    class="form-control form-control-sm" value="<?=$tgl; ?>" id="written"
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-1 mb-1">
                                <input type="text" name="taxrate" autocomplete="off"
                                    class="form-control form-control-sm" value="0.00" id="taxrate"
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-1">
                                <input type="text" name="address2" autocomplete="off"
                                    class="form-control form-control-sm" id="address2" placeholder="Pos code">
                            </div>
                            <div class="col-md-2 mb-1 align-right">
                                <label>CN / Disc</label>
                            </div>
            ...
            <div class="modal-footer">
                <button type="button" data-toggle="tooltip" data-placement="top" title="Add Item" class="btn btn-info"
                    id="addRow" data-bs-toggle="modal" data-bs-target="#exampleModal3" data-bs-dismiss="modal">Add Item</button>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" data-bs-toggle="modal"
                    data-bs-target="#exampleModal1">Close</button>
                <button type="button" class="btn btn-info addStin" data-bs-dismiss="modal" id="saveRow"><i
...
<div class="modal fade tiga " id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-row">
                            ...
                            <div class="col-2 mb-1">
                                <input type="text" disabled name="custcode2"
                                    class="form-control form-control-sm custcode" aria-describedby="" placeholder=""
                                    disabled>
                            </div>
                            <div class="col-4 mb-1">
                                <input type="text" value="HO" name="company2"
                                    class="form-control form-control-sm company" placeholder="" disabled>
                            </div>
                            ...
                            <div class="col-2 mb-1">
                                <input class="form-control form-control-sm invoiceNo"
                                    value="{{ Auth::user()->FullName }}" name="invoice" type="text" disabled>
                            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="saveBtn" data-bs-toggle="modal"
                    data-bs-target="#exampleModal2" data-bs-dismiss="modal">Save changes</button>
            </div>
        </div>
    </div>
</div>
