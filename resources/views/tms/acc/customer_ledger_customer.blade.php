@extends('master')
@section('title', 'TMS | Customer Ledger per Customer')
@section('content')
@php
        ...
        <div class="col-12 mt-6">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <h4 class="card-header-title">Customer Ledger per Customer</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
...
<script src="{{ asset('/js/scriptCLCustomer.js') }}"></script>
@endsection
