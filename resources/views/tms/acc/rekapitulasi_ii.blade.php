...
@section('title', 'TMS | Rekapitulasi Penjualan II')
        ...
        <div class="col-12 mt-6">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <h4 class="card-header-title">Rekapitulasi Penjualan II</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="reportTitle" autocomplete="off" value="REKAPITULASI PENJUALAN" class="form-control form-control-sm" id="reportTitle">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
...
<script src="{{asset('/js/scriptRekapitulasiii.js')}}"></script>
@endsection
