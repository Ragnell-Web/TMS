@extends('master')
@section('title', 'TMS | Aging per Sales - Last Payment')
@section('content')
@php
        ...
        <div class="col-12 mt-6">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <h4 class="card-header-title">Aging per Sales - Last Payment</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <input type="text" name="interestRate" id="interestRate" autocomplete="off"
                                    class="form-control form-control-sm" value="0.00" disabled>
                            </div>
                            <div class="col-md-1">
...
<script src="{{asset('/js/scriptAgsLastPayment.js')}}"></script>
@endsection
