@extends('master')
@section('title', 'TMS | Aging per Sales - Sales Interest')
@section('content')
@php
        ...
        <div class="col-12 mt-6">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <h4 class="card-header-title">Aging per Sales - Sales Interest</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <label for="interestRateYear">Interest Rate / Year :</label>
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="interestRateYear" id="interestRateYear" autocomplete="off"
                                    class="form-control form-control-sm" value="18.00">
                            </div>
                            <div class="col-md-1">
                                <label for="interestRateYear">%</label>
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="interestRateYear2" id="interestRateYear2" autocomplete="off"
                                    class="form-control form-control-sm" value="60">
                            </div>
                            <div class="col-md-1">
                                <label for="interestRateYear2">day</label>
                            </div>
                        </div>
                        <div class="form-row">
                          <div class="col-md-2 ms-auto">
                            <input type="text" name="interestRate" id="interestRate" autocomplete="off"
                                    class="form-control form-control-sm" value="75.00">
                          ...
                          <div class="col-md-3">
                            <label for="interestRate">(Company)</label>
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="col-md-2 ms-auto">
                            <input type="text" name="interestRate2" id="interestRate2" autocomplete="off"
                                    class="form-control form-control-sm" value="20.00">

                          </div>
                          <div class="col-md-1">
                            <label for="interestRate2">%</label>
                          </div>
                          <div class="col-md-3">
                            <label for="interestRate2">(Marketing)</label>
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="col-md-2 ms-auto">
                            <input type="text" name="interestRate3" id="interestRate3" autocomplete="off"
                                    class="form-control form-control-sm" value="5.00">
                          ...
                          <div class="col-md-3">
                            <label for="interestRate">(Sales)</label>
                          </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6">
...
<script src="{{asset('/js/scriptAgsSalesInterest.js')}}"></script>
@endsection
