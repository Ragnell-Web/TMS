@extends('master')
@section('title', 'TMS | Customer Ledger Total')
@section('content')
        ...
        <div class="col-12 mt-6">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <h4 class="card-header-title">Customer Ledger Total</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 d-flex flex-row">
                                <div class="form-check me-2">
                                    <input class="form-check-input" type="radio" name="showVoided" id="dataNo"
                                        value="no" checked>
                                ...
                                <div class="form-check me-2">
                                    <input class="form-check-input" type="radio" name="showVoided" id="dataYes"
                                        value="yes">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 d-flex flex-row">
                                <div class="form-check me-2">
                                    <input class="form-check-input" type="radio" name="recalculate" id="dataNo2"
                                        value="no">
                                    <label class="form-check-label" for="dataNo2">
                                        No
                                    </label>
                                </div>
                                <div class="form-check me-2">
                                    <input class="form-check-input" type="radio" name="recalculate" id="dataYes2"
                                        value="yes" checked>
                                    <label class="form-check-label" for="dataYes2">
                                        Yes
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <label for="sortBy">Report Form :</label>
                            </div>
                            <div class="col-md-6">
...
<script src="{{ asset('/js/scriptCLTotal.js') }}"></script>
@endsection
