@extends('master')
@section('title', 'TMS | List Of Item Sold (Hartana)')
@section('content')
<?php
        ...
        <div class="col-12 mt-6">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <h4 class="card-header-title">List Of Item Sold (Hartana)</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <input type="input" name="period" autocomplete="off"
                                        class="form-control form-control-sm" id="period" value="{{$tgl}}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
...
<script src="{{asset('/js/scriptListItemHartana.js')}}"></script>
@endsection
