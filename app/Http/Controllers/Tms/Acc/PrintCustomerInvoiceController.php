...
class PrintCustomerInvoiceController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('tms.acc.print_customer_invoice')->with('datasInvoices', $datasInvoices['data'])->with('datasSuratJalan',$datasSuratJalan['data']);
    }
    public function create(Request $request)
    {
        ...
        return redirect()->route('print_Index')->with('datas',$datas['data']);
    }
